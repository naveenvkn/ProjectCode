...
<br><br>
 <table align="center" border="0" width="1000">
	...
	<%! String asth,mnoh,imt,mno,mdate,ast,ides,imake,pstat,stat,res,recon,sql,bname,ecode,ename,type,mail,ncal,lcal,col,adate;
		int sno;
	%>
	<% asth=request.getParameter("asth");
		mnoh=request.getParameter("mnoh");
	%>
	<%	
		...
		try
		{
			...
			if(mnoh.equals(""))
			{
				sql="select * from Asthistory where Assettype='"+asth+"'";
			}
			else
			{
				sql="select * from Asthistory where Assettype='"+asth+"' and Manfno='"+mnoh+"'";
			}
